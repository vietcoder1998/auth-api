...
export const mockPermissions = [
  ...
  {
    name: 'config_get',
    description: 'GET config endpoint',
    category: 'api',
    route: '/api/config',
    method: 'GET',
  },
  {
    name: 'config_get_by_key',
    description: 'GET config by key endpoint',
    category: 'api',
  ...
  {
    name: 'config_post',
    description: 'POST config endpoint',
    category: 'api',
    route: '/api/config',
    method: 'POST',
  },
  {
    name: 'config_put',
    description: 'PUT config endpoint',
    category: 'api',
    route: '/api/config',
    method: 'PUT',
  },
  {
    name: 'config_delete',
    description: 'DELETE config endpoint',
    category: 'api',
    route: '/api/config/:key',
    method: 'DELETE',
  },
  ...
  {
    name: 'sso_auth_login',
    description: 'POST SSO auth login endpoint',
    category: 'api',
    route: '/api/sso-auth/login',
    method: 'POST',
  },
  {
    name: 'sso_auth_logout',
    description: 'POST SSO auth logout endpoint',
    category: 'api',
    route: '/api/sso-auth/logout',
    method: 'POST',
  },
  {
    name: 'sso_auth_me',
    description: 'GET SSO auth me endpoint',
    category: 'api',
    route: '/api/sso-auth/me',
    method: 'GET',
  },
  {
    name: 'sso_auth_validate_key',
    description: 'POST SSO auth validate key endpoint',
    category: 'api',
    route: '/api/sso-auth/validate-key',
    method: 'POST',
  },
  {
    name: 'sso_auth_validate',
    description: 'GET SSO auth validate endpoint',
    category: 'api',
    route: '/api/sso-auth/validate',
    method: 'GET',
  },
  ...
  // Route-based permissions with full HTTP method support
  {
    ...
    description: 'GET admin users endpoint',
    category: 'api',
    route: '/api/admin/users',
    method: 'GET',
  },
  {
    ...
    description: 'POST admin users endpoint',
    category: 'api',
    route: '/api/admin/users',
    method: 'POST',
  },
  {
    name: 'admin_users_put',
    description: 'PUT admin users endpoint',
    category: 'api',
    route: '/api/admin/users/:id',
    method: 'PUT',
  },
  {
    ...
    description: 'PATCH admin users endpoint',
    category: 'api',
    route: '/api/admin/users/:id',
    method: 'PATCH',
  },
  {
    ...
    description: 'DELETE admin users endpoint',
    category: 'api',
    route: '/api/admin/users/:id',
    method: 'DELETE',
  },

  {
    ...
    description: 'GET admin roles endpoint',
    category: 'api',
    route: '/api/admin/roles',
    method: 'GET',
  },
  {
    name: 'admin_roles_post',
    description: 'POST admin roles endpoint',
    category: 'api',
    route: '/api/admin/roles',
    method: 'POST',
  },
  {
    name: 'admin_roles_put',
    description: 'PUT admin roles endpoint',
    category: 'api',
    route: '/api/admin/roles/:id',
    method: 'PUT',
  },
  {
    ...
    description: 'PATCH admin roles endpoint',
    category: 'api',
    route: '/api/admin/roles/:id',
    method: 'PATCH',
  },
  {
    ...
    description: 'DELETE admin roles endpoint',
    category: 'api',
    route: '/api/admin/roles/:id',
    method: 'DELETE',
  },
  {
    name: 'admin_roles_permissions_available',
    description: 'GET admin roles available permissions endpoint',
    category: 'api',
    route: '/api/admin/roles/:id/permissions/available',
    method: 'GET',
  },
  {
    name: 'admin_roles_permissions_add',
    description: 'POST admin roles add permissions endpoint',
    category: 'api',
    route: '/api/admin/roles/:id/permissions/add',
    method: 'POST',
  },

  // Additional Permission endpoints
  {
    name: 'admin_permissions_with_superadmin',
    description: 'POST admin permissions with superadmin endpoint',
    category: 'api',
    route: '/api/admin/permissions/with-superadmin',
    method: 'POST',
  },
  {
    name: 'admin_permissions_add_to_superadmin',
    description: 'POST admin permissions add to superadmin endpoint',
    category: 'api',
    route: '/api/admin/permissions/:permissionId/add-to-superadmin',
    method: 'POST',
  },
  ...
  // Additional User endpoints
  {
    ...
    description: 'GET admin users search endpoint',
    category: 'api',
    route: '/api/admin/users/search',
    method: 'GET',
  },
  {
    name: 'admin_users_delete_by_email',
    description: 'DELETE admin users by email endpoint',
    category: 'api',
  ...
  {
    name: 'admin_mails_patch_sent',
    description: 'PATCH admin mails mark as sent endpoint',
    category: 'api',
    route: '/api/admin/mails/:id/sent',
    method: 'PATCH',
  },
  {
    name: 'admin_mails_patch_failed',
    description: 'PATCH admin mails mark as failed endpoint',
    category: 'api',
    route: '/api/admin/mails/:id/failed',
    method: 'PATCH',
  },
  {
    name: 'admin_mails_patch_resend',
    description: 'PATCH admin mails resend endpoint',
    category: 'api',
    route: '/api/admin/mails/:id/resend',
    method: 'PATCH',
  },
  ...
  {
    name: 'admin_permissions_get',
    description: 'GET admin permissions endpoint',
    category: 'api',
    route: '/api/admin/permissions',
    method: 'GET',
  },
  {
    name: 'admin_permissions_post',
    description: 'POST admin permissions endpoint',
    category: 'api',
    route: '/api/admin/permissions',
    method: 'POST',
  },
  {
    name: 'admin_permissions_put',
    description: 'PUT admin permissions endpoint',
    category: 'api',
    route: '/api/admin/permissions/:id',
    method: 'PUT',
  },
  {
    name: 'admin_permissions_patch',
    description: 'PATCH admin permissions endpoint',
    category: 'api',
    route: '/api/admin/permissions/:id',
    method: 'PATCH',
  },
  {
    name: 'admin_permissions_delete',
    description: 'DELETE admin permissions endpoint',
    category: 'api',
    route: '/api/admin/permissions/:id',
    method: 'DELETE',
  },
  ...
  {
    name: 'admin_mail_templates_patch',
    description: 'PATCH admin mail templates endpoint',
    category: 'api',
    route: '/api/admin/mail-templates/:id',
    method: 'PATCH',
  },
  ...
  {
    name: 'admin_mails_get',
    description: 'GET admin mails endpoint',
    category: 'api',
    route: '/api/admin/mails',
    method: 'GET',
  },
  {
    name: 'admin_mails_post',
    description: 'POST admin mails endpoint',
    category: 'api',
    route: '/api/admin/mails',
    method: 'POST',
  },
  {
    name: 'admin_mails_put',
    description: 'PUT admin mails endpoint',
    category: 'api',
    route: '/api/admin/mails/:id',
    method: 'PUT',
  },
  {
    name: 'admin_mails_patch',
    description: 'PATCH admin mails endpoint',
    category: 'api',
    route: '/api/admin/mails/:id',
    method: 'PATCH',
  },
  {
    name: 'admin_mails_delete',
    description: 'DELETE admin mails endpoint',
    category: 'api',
    route: '/api/admin/mails/:id',
    method: 'DELETE',
  },
  {
    name: 'admin_mails_stats',
    description: 'GET admin mails statistics endpoint',
    category: 'api',
    route: '/api/admin/mails/stats',
    method: 'GET',
  },
  {
    name: 'admin_mails_get_by_id',
    description: 'GET admin mail by ID endpoint',
    category: 'api',
    route: '/api/admin/mails/:id',
    method: 'GET',
  },
  {
    name: 'admin_mails_sent',
    description: 'PATCH admin mails mark as sent endpoint',
    category: 'api',
    route: '/api/admin/mails/:id/sent',
    method: 'PATCH',
  ...
  {
    name: 'admin_cache_put',
    description: 'PUT admin cache endpoint',
    category: 'api',
    route: '/api/admin/cache/:key',
    method: 'PUT',
  },
  {
  ...
  },
  {
    ...
    description: 'DELETE admin cache clear endpoint',
    category: 'api',
  ...
  {
    name: 'admin_cache_get_by_key',
    description: 'GET admin cache by key endpoint',
    category: 'api',
    route: '/api/admin/cache/:key',
    method: 'GET',
  },
  {
    name: 'admin_cache_delete_by_key',
    description: 'DELETE admin cache by key endpoint',
    category: 'api',
    route: '/api/admin/cache/:key',
    method: 'DELETE',
  },
  {
    name: 'admin_cache_clear_pattern',
    description: 'POST admin cache clear by pattern endpoint',
    category: 'api',
    route: '/api/admin/cache/clear',
    method: 'POST',
  },
  ...
  {
    name: 'admin_sso_get',
    description: 'GET admin SSO endpoint',
    category: 'api',
    route: '/api/admin/sso',
    method: 'GET',
  },
  {
    name: 'admin_sso_post',
    description: 'POST admin SSO endpoint',
    category: 'api',
    route: '/api/admin/sso',
    method: 'POST',
  },
  {
    name: 'admin_sso_put',
    description: 'PUT admin SSO endpoint',
    category: 'api',
    route: '/api/admin/sso/:id',
    method: 'PUT',
  },
  {
    name: 'admin_sso_patch',
    description: 'PATCH admin SSO endpoint',
    category: 'api',
    route: '/api/admin/sso/:id',
    method: 'PATCH',
  },
  {
    ...
    description: 'DELETE admin SSO endpoint',
    category: 'api',
    route: '/api/admin/sso/:id',
    method: 'DELETE',
  },
  {
    name: 'admin_sso_regenerate',
    description: 'PATCH admin SSO regenerate key endpoint',
    category: 'api',
    route: '/api/admin/sso/:id/regenerate-key',
    method: 'PATCH',
  },
  {
  ...
  {
    name: 'admin_sso_get_by_id',
    description: 'GET admin SSO by ID endpoint',
    category: 'api',
    route: '/api/admin/sso/:id',
    method: 'GET',
  },
  ...
  {
    name: 'manage_sso',
    description: 'Full SSO management access',
    category: 'sso',
    route: '/api/admin/sso',
    method: 'ALL',
  },
  ...
  {
    name: 'manage_login_history',
    description: 'Full login history management',
    category: 'history',
    route: '/api/admin/login-history',
    method: 'ALL',
  },
  {
    name: 'view_logic_history',
    description: 'View logic history and audit trail',
    category: 'history',
    route: '/api/admin/logic-history',
    method: 'GET',
  },
  {
    name: 'manage_logic_history',
    description: 'Full logic history management',
    category: 'history',
    route: '/api/admin/logic-history',
    method: 'ALL',
  },
  ...
  {
    name: 'manage_cache',
    description: 'Full cache management access including clear and modify',
    category: 'cache',
    route: '/api/admin/cache',
    method: 'ALL',
  },
  {
    name: 'cache_admin',
    description: 'Administrative cache operations and monitoring',
    category: 'cache',
    route: '/api/admin/cache',
    method: 'ALL',
  },
  ...
  {
    name: 'admin_agents_patch',
    description: 'PATCH admin agents endpoint',
    category: 'api',
    route: '/api/admin/agents/:id',
    method: 'PATCH',
  },
  ...
  {
    name: 'admin_agents_memories_put',
    description: 'PUT admin agent memories endpoint',
    category: 'api',
    route: '/api/admin/agents/:id/memories/:memoryId',
    method: 'PUT',
  },
  {
    name: 'admin_agents_memories_patch',
    description: 'PATCH admin agent memories endpoint',
    category: 'api',
    route: '/api/admin/agents/:id/memories/:memoryId',
    method: 'PATCH',
  },
  {
    name: 'admin_agents_memories_delete',
    description: 'DELETE admin agent memories endpoint',
    category: 'api',
    route: '/api/admin/agents/:id/memories/:memoryId',
    method: 'DELETE',
  },
  {
    name: 'admin_agents_get_by_id',
    description: 'GET admin agent by ID endpoint',
    category: 'api',
    route: '/api/admin/agents/:id',
    method: 'GET',
  },
  ...
  {
    name: 'admin_conversations_get_by_id',
    description: 'GET admin conversation by ID endpoint',
    category: 'api',
  ...
  { name: 'view_ai_agents', description: 'View AI agents and conversations', category: 'ai' },
  {
    ...
    description: 'Chat with AI agents and create conversations',
    category: 'ai',
  },
  ...
  {
    name: 'admin_seed_permissions',
    description: 'POST admin seed permissions endpoint',
    category: 'api',
    route: '/api/admin/seed/permissions',
    method: 'POST',
  },
  {
    name: 'admin_seed_roles',
    description: 'POST admin seed roles endpoint',
    category: 'api',
    route: '/api/admin/seed/roles',
    method: 'POST',
  },
  {
    name: 'admin_seed_users',
    description: 'POST admin seed users endpoint',
    category: 'api',
    route: '/api/admin/seed/users',
    method: 'POST',
  },
  {
    name: 'admin_seed_configs',
    description: 'POST admin seed configs endpoint',
    category: 'api',
    route: '/api/admin/seed/configs',
    method: 'POST',
  },
  {
    name: 'admin_seed_agents',
    description: 'POST admin seed agents endpoint',
    category: 'api',
    route: '/api/admin/seed/agents',
    method: 'POST',
  },
  {
    name: 'admin_seed_api_keys',
    description: 'POST admin seed API keys endpoint',
    category: 'api',
    route: '/api/admin/seed/api-keys',
    method: 'POST',
  },
  {
  ...
  {
    name: 'manage_database_seed',
    description: 'Full database seeding management access',
    category: 'system',
  },
  {
    name: 'view_database_stats',
    description: 'View database statistics and counts',
    category: 'system',
  },
  { name: 'seed_data', description: 'Seed database with default data', category: 'system' },
  {
    name: 'clear_database',
    description: 'Clear all data from database (dangerous)',
    category: 'system',
  },
  ...
  {
    name: 'admin_logs_get',
    description: 'GET admin logs endpoint',
    category: 'api',
    route: '/api/admin/logs',
    method: 'GET',
  },
  {
    name: 'admin_logs_post',
    description: 'POST admin logs endpoint',
    category: 'api',
    route: '/api/admin/logs',
    method: 'POST',
  },
  {
    name: 'admin_logs_stats',
    description: 'GET admin logs statistics endpoint',
    category: 'api',
    route: '/api/admin/logs/stats',
    method: 'GET',
  },
  {
    name: 'admin_logs_export',
    description: 'GET admin logs export endpoint',
    category: 'api',
    route: '/api/admin/logs/export',
    method: 'GET',
  },
  {
    name: 'admin_logs_clear',
    description: 'DELETE admin logs clear old logs endpoint',
    category: 'api',
    route: '/api/admin/logs/clear',
    method: 'DELETE',
  },
  ...
  {
    name: 'manage_logs',
    description: 'Full log management access including clear and export',
    category: 'logs',
  },
  ...
  {
    name: 'clear_old_logs',
    description: 'Clear old log entries to manage storage',
    category: 'logs',
  },
  ...
  {
    name: 'admin_database_connections_get_by_id',
    description: 'GET admin database connection by ID endpoint',
    category: 'api',
  ...
  {
    name: 'view_database_connections',
    description: 'View database connections and their status',
    category: 'database',
  },
  {
    name: 'manage_database_connections',
    description: 'Full database connection management access',
    category: 'database',
  },
  {
    name: 'create_database_connections',
    description: 'Create new database connections',
    category: 'database',
  },
  {
    name: 'update_database_connections',
    description: 'Update existing database connections',
    category: 'database',
  },
  {
    name: 'delete_database_connections',
    description: 'Delete database connections',
    category: 'database',
  },
  {
    name: 'test_database_connections',
    description: 'Test database connections for connectivity',
    category: 'database',
  },
  {
    name: 'backup_databases',
    description: 'Create backups of connected databases',
    category: 'database',
  },
  ...
  {
    name: 'socket_view',
    description: 'View socket configurations',
    category: 'socket',
  ...
  {
    name: 'socket_create',
    description: 'Create socket configuration',
    category: 'socket',
    route: '/api/admin/sockets',
    method: 'POST',
  },
  {
    name: 'socket_update',
    description: 'Update socket configuration',
    category: 'socket',
  ...
  {
    name: 'socket_delete',
    description: 'Delete socket configuration',
    category: 'socket',
    route: '/api/admin/sockets/:id',
    method: 'DELETE',
  },
  {
    name: 'socket_event_view',
    description: 'View socket events',
    category: 'socket_event',
    route: '/api/admin/sockets/:socketConfigId/events',
    method: 'GET',
  },
  {
    name: 'socket_event_create',
    description: 'Create socket event',
    category: 'socket_event',
    route: '/api/admin/sockets/:socketConfigId/events',
    method: 'POST',
  },
  {
    name: 'socket_event_delete',
    description: 'Delete socket event',
    category: 'socket_event',
    route: '/api/admin/sockets/events/:id',
    method: 'DELETE',
  },
  {
    name: 'socket_event_add_user',
    description: 'Add user to socket event',
    category: 'socket_event',
    route: '/api/admin/sockets/:socketConfigId/add-user',
    method: 'POST',
  },
];
