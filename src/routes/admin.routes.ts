...
import permissionGroupRouter from './permissionGroup.routes';
...
router.use(documentRoutes.path, documentRoutes.routes);
router.use('/faqs', faqRouter);
router.use('/ui-config', uiConfigRouter);
router.use(jobRoutes.path, jobRoutes.routes);
