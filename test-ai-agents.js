  ...
  try {
    ...
    const agent = await prisma.agent.create({
      data: {
        ...
        model: 'gpt-4',
        systemPrompt: 'You are a helpful and friendly AI assistant. Always be polite and informative.',
    ...
    const agentMessage = await prisma.message.create({
      data: {
        conversationId: conversation.id,
        sender: 'agent',
        content: 'Hello! I\'d be happy to help you understand AI agents. AI agents are autonomous systems that can perceive their environment, make decisions, and take actions to achieve specific goals. They typically have components like memory, reasoning, and the ability to interact with tools or APIs.',
        tokens: 45
      }
    });
